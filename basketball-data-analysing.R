...
#Matrix
free_throws <- rbind(KobeBryant_FT, JoeJohnson_FT, LeBronJames_FT, CarmeloAnthony_FT,
                     DwightHoward_FT, ChrisBosh_FT, ChrisPaul_FT,
...
#Matrix
free_throw_attempts <- rbind(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA,
                     DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA,
                     KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
rownames(free_throw_attempts) = Players
...
#Bind the given vectors to form the matrix
free_throw_attempts <- _(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA, KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
#Remove vectors - we don't need them anymore
...
myplot(free_throw_attempts/Games)
...
myplot((Points-free_throws)/FieldGoals)
